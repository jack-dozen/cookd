...
from src.scrapers.tokopedia_scraper import tokpedia_scraper

try:
    from src.scrapers.alfagift_scraper import scrape_keywords as _alfa_scrape_keywords
    _ALFA_AVAILABLE = True
except ImportError:
    _ALFA_AVAILABLE = False

try:
    from src.scrapers.aeon_scraper import scrape_by_keyword as _aeon_scrape
    from src.scrapers.aeon_scraper import init_driver as _aeon_init_driver
...
_db_cache = None
from src.core.db_lock import DB_LOCK as _db_lock, DRIVER_INIT_LOCK as _driver_init_lock
