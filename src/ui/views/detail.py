"""
detail.py — CookD Detail Page (formerly hadi/ui/detail.py)
"""
...
from src.core.theme import theme_mgr, ORANGE, ORANGE_GLOW2, WHITE
from src.ui.views.price_panel import run_price_calculation
