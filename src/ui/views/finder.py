"""
finder.py — CookD Finder Page (formerly hadi/ui/finder.py)
Halaman pencarian resep berdasarkan bahan.
"""
...
from src.scrapers import cookpad_scraper as CookpadScraper
from src.core.theme import theme_mgr, ORANGE, ORANGE_GLOW, GREEN, AMBER, WHITE
from src.ui.components.save_btn import build_save_btn
...
def build_finder_page(page: ft.Page, show_detail_fn) -> ft.Container:
    ...
    # Expose prefill function for home page
