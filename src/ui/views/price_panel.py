"""
price_panel.py — CookD Price Panel UI
(formerly zaky/price_panel.py)
...
from src.ui.components.ingredient_price_list import build_ingredient_list
...
def _build_bar_chart(result) -> ft.Container:
    ...
    LABEL_H = 18    # tinggi zona label nilai di atas bar
...
# ══════════════════════════════════════════════════════════════════════════════
# ORCHESTRATOR — dipanggil langsung dari tombol di detail page
# ══════════════════════════════════════════════════════════════════════════════
...
def run_price_calculation(
    ...
    def _work():
        try:
            from src.services.price_comparison import PriceComparisonService
            ...
            try:
                from src.services.price_comparison import PriceResult
