"""
sidebar_extras.py — CookD Sidebar Extras
(formerly rafy/sidebar.py)
...
import flet as ft
from src.core.theme import theme_mgr, build_theme_toggle
...
def build_sidebar_extras(page: ft.Page, on_import_done=None) -> list:
    ...
    def show_import_export_dialog(e):
        ...
        def do_export(e):
            dialog.open = False
            page.update()
            from src.ui.dialogs.exporter import show_export_dialog  # ← eksporter, bukan exporter
            show_export_dialog(page)

        def do_import(e):
            dialog.open = False
            page.update()
            from src.ui.dialogs.importer import show_import_dialog  # ← bukan import_my_recipes
