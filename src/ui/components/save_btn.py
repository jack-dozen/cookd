"""
save_btn.py — CookD Save Button Component (formerly fadhil/save_btn.py)
Tombol simpan resep ke My Recipes.
"""

import os
import flet as ft
from src.ui.views.my_recipes import save_recipe, is_saved
